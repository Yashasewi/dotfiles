...
# Load mise (runtime/version manager)
...
plugins=(git poetry zsh-eza zsh-syntax-highlighting starship zsh-autosuggestions)
...
# bun completions
[ -s "/Users/yashasewi/.bun/_bun" ] && source "/Users/yashasewi/.bun/_bun"
...
alias ls='eza --icons -1 -a -l --time-style long-iso --group-directories-first'
alias ll='eza --icons -lh --git --time-style long-iso --group-directories-first'
alias la='eza --icons -lah --git --time-style long-iso --group-directories-first'
